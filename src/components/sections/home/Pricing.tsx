...
const DEFAULT_PRICING = {
  ...
  mainDescription:
    'Select the perfect plan to dominate the leaderboards. Unlock exclusive games, tournaments, and premium features.',
  ...
  plan1Price: 'Free',
  plan1CTA: 'Start Gaming',
  plan1CTAHref: '/signup',
  plan2Name: 'Pro Gamer',
  plan2Description: 'For serious gamers and tournament players',
  plan2Price: '$19',
  plan2Period: '/month',
  ...
  bottomTitle: 'Need a custom gaming setup?',
  bottomDescription:
    "We offer specialized gaming packages for esports teams, gaming cafes, and professional streamers. Let's create the perfect gaming environment for you.",
  bottomCTA: 'Contact Gaming Experts',
