...
const DEFAULT_FOOTER = {
  ...
  companyDescription:
    'The ultimate gaming platform where players connect, compete, and conquer. Experience next-generation gaming with cutting-edge technology and immersive gameplay.',
  contactEmail: 'support@gamestation.com',
  ...
  linkFeatures: 'Game Library',
  linkFeaturesHref: '#games',
  linkPricing: 'Pricing Plans',
  linkPricingHref: '#pricing',
  linkTemplates: 'Tournaments',
  linkTemplatesHref: '/tournaments',
  ...
  linkHelpHref: '/help',
  linkCommunity: 'Discord',
  linkCommunityHref: '/discord',
  linkTutorials: 'How to Play',
  linkTutorialsHref: '/tutorials',
  linkWebinars: 'Live Events',
